package com.hpccsystems.jdbcdriver.tests;
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			if(args.length <= 0)
			{
				...
				expectedFailure |= !(executeFreeHandSQL(info, "select persons.firstname, persons.lastname from tutorial::rp::tutorialperson as persons where persons.firstname >= 'a' order by persons.lastname ASC, persons.firstname DESC limit 10", params));
