...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
  ...
  set(majorver ${JDBC_MAJOR})
  set(minorver ${JDBC_MINOR})
  set(point ${JDBC_POINT})
  if ( "${JDBC_MATURITY}" STREQUAL "release" )
    set(stagever "${JDBC_SEQUENCE}")
  else()
    set(stagever "${JDBC_SEQUENCE}${JDBC_MATURITY}")
  endif()
